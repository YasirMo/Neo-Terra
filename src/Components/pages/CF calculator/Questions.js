const questions = [
    ...
    {
        questionText: 'What type of house do you live in?',
        answerOptions: [
    ...
    {
        questionText: 'How many cars are used in your household?' ,
        answerOptions: [
    ...
    {
        questionText: 'What is the type of your car?',
        answerOptions: [
    ...
    {
        questionText: 'What is the annual mileage for your car?',
        answerOptions: [
    ...
    {
        questionText: 'How much of the food that you eat is organic?',
        answerOptions: [
    ...
    {
        questionText: 'How much meat/diary do you eat personally?',
        answerOptions: [
    ...
    {
        questionText: 'How much of your food is produced locally?',
        answerOptions: [
    ...
    {
        questionText: 'How much of your food is packed/processed (e.g. ready meals, tins)?',
        answerOptions: [
            { answerText: 'Above average', Value: 1},
            { answerText: 'Average', Value: 2},
            { answerText: 'Below average', Value: 3},
    ...
    {
        questionText: 'How much do you compost potato peelings, leftover and unused food, etc?',
        answerOptions: [
            { answerText: 'none', Value: 1},
            { answerText: 'some', Value: 2},
    ...
    {
        questionText: 'How much of your food do you waste (on average over 1/5 of edible food is thrown away)?',
        answerOptions: [
            { answerText: 'Above average', Value: 1},
            { answerText: 'Average', Value: 2},
            { answerText: 'Below average', Value: 3},
    ...
    {
        questionText: 'Weekly, how long do you take the bus? (Choose the closest answer)',
        answerOptions: [
    ...
    {
        questionText: 'Weekly, how long do you take the train? (Choose the closest answer)',
        answerOptions: [
    ...
    {
        questionText: 'How often do you take flights during the year?',
        answerOptions: [
    ...
    {
        questionText: 'Roughly, how long does your flights last?',
        answerOptions: [
    ...
    {
        questionText: 'What is your miscellaneous spending?',
        answerOptions: [
            { answerText: 'Above average', Value: 1},
            { answerText: 'Average', Value: 2},
            { answerText: 'Below average', Value: 3},
    ...
    {
        questionText: 'Do you recycle paper, glass and metal?',
        answerOptions: [
    ...
    {
        questionText: 'Do you recycle plastic apart from bags?',
        answerOptions: [
            { answerText: 'Yes', Value: 1},
            { answerText: 'No', Value: 2},
        ],
